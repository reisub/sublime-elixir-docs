...
class ModuleListInputHandler(sublime_plugin.ListInputHandler):
    ...
    def elixir_modules(self):
        # generated with 'elixir generate.exs'
        modules = ["Access", "Agent", "Application", "ArgumentError", "ArithmeticError", "Atom", "BadArityError", "BadBooleanError", "BadFunctionError", "BadMapError", "BadStructError", "Base", "Behaviour", "Bitwise", "Calendar", "Calendar.ISO", "Calendar.TimeZoneDatabase", "Calendar.UTCOnlyTimeZoneDatabase", "CaseClauseError", "Code", "Code.LoadError", "Collectable", "CompileError", "CondClauseError", "Config", "Config.Provider", "Config.Reader", "Date", "Date.Range", "DateTime", "Dict", "DynamicSupervisor", "Enum", "Enum.EmptyError", "Enum.OutOfBoundsError", "Enumerable", "ErlangError", "Exception", "File", "File.CopyError", "File.Error", "File.LinkError", "File.RenameError", "File.Stat", "File.Stream", "Float", "Function", "FunctionClauseError", "GenEvent", "GenServer", "HashDict", "HashSet", "IO", "IO.ANSI", "IO.Stream", "IO.StreamError", "Inspect", "Inspect.Algebra", "Inspect.Error", "Inspect.Opts", "Integer", "Kernel", "Kernel.ParallelCompiler", "Kernel.SpecialForms", "KeyError", "Keyword", "List", "List.Chars", "Macro", "Macro.Env", "Map", "MapSet", "MatchError", "Module", "Module.Types.Error", "NaiveDateTime", "Node", "OptionParser", "OptionParser.ParseError", "Path", "Port", "Process", "Protocol", "Protocol.UndefinedError", "Range", "Record", "Regex", "Regex.CompileError", "Registry", "RuntimeError", "Set", "Stream", "String", "String.Chars", "StringIO", "Supervisor", "Supervisor.Spec", "SyntaxError", "System", "SystemLimitError", "Task", "Task.Supervisor", "Time", "TokenMissingError", "TryClauseError", "Tuple", "URI", "UndefinedFunctionError", "UnicodeConversionError", "Version", "Version.InvalidRequirementError", "Version.InvalidVersionError", "Version.Requirement", "WithClauseError"]
